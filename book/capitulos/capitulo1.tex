...
En los siguientes capítulos presentamos modelos de predicción de indice de fragmentación, entrenados para detectar si supera unos umbrales predefinidos, implementados con técnicas de aprendizaje automático o \textit{Machine Learning}, los cuales se utilizan como estrategia de disparo del proceso de desfragmentación pero en este caso redes SDM-EON Multinúcleo, proponiendo de esta manera una solución al sub problema planteado anteriormente. 
%
