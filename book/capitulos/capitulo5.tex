...
\hline
\textbf{Demandas totales} & 99,950 & 100,090 &  99,720 & \textbf{99,601} \\
\textbf{Bloqueos (BL)} & 857 & 730 & 685 & \textbf{717} \\
\textbf{Prob. bloqueo} & 0.857\% & 0.729\% & 0.687\% & \textbf{0.720\%} \\
\textbf{Desfragmentaciones} & 0 & 19 &  13 & \textbf{11} \\
\hline
\end{tabular}
\end{table}
...
\textbf{Métrica} & \textbf{SD} & \textbf{MR1} & \textbf{MR2} & \textbf{MP} \\
 & \textbf{(Sin Desfrag.)} & \textbf{(Periódico)} & \textbf{(Umbral)} & \textbf{(Doble Umbral)} \\
\hline
\textbf{Demandas totales} & 99,590 & 100,184 & 100,023 & \textbf{100,066}\\
\textbf{Bloqueos (BL)} & 1,693 & 1,561 & 1,473 & \textbf{1,397} \\
\textbf{Prob. bloqueo} & 1.700\% & 1.558\% & 1.473\% & \textbf{1.397\%} \\
\textbf{Desfragmentaciones} & 0 & 19 & 16 & \textbf{15} \\
\hline
\end{tabular}
\end{table}
...
\textbf{Métrica} & \textbf{SD} & \textbf{MR1} & \textbf{MR2} & \textbf{MP} \\
 & \textbf{(Sin Desfrag.)} & \textbf{(Periódico)} & \textbf{(Umbral)} & \textbf{(Doble Umbral)} \\
\hline
\textbf{Demandas totales} & 99,752 & 99,896 & 100,174 &  \textbf{100,066} \\
\textbf{Bloqueos (BL)} & 3,576 & 3,262 & 2,986 & \textbf{2,873}\\
\textbf{Prob. bloqueo} & 3.585\% & 3.265\% & 2.981\% & \textbf{2.871\%} \\
\textbf{Desfragmentaciones} & 0 & 19 & 18 & \textbf{18} \\
\hline
\end{tabular}
\end{table}
