...
El método propuesto implementa una estrategia de tres niveles basada en la predicción del índice de fragmentación BFR en horizonte $t+1000$ mediante dos modelos Gradient Boosting entrenados. La estrategia adaptativa opera según los siguientes criterios:
...
\hline
\textbf{Demandas totales} & 99,950 & 100,090 & 99,601 & 99,720 \\
\textbf{Bloqueos (BL)} & 857 & 730 & 717 & \textbf{685} \\
\textbf{Prob. bloqueo} & 0.857\% & 0.729\% & 0.720\% & \textbf{0.687\%} \\
\textbf{Desfragmentaciones} & 0 & 19 & 11 & 13 \\
\textbf{Desfrag. preventivas} & - & 19 (100\%) & - & 13 (100\%) \\
\textbf{Desfrag. reactivas} & - & - & 11 (100\%) & 0 (0\%) \\
\hline
\end{tabular}
\end{table}
...
\textbf{Métrica} & \textbf{SD} & \textbf{MR1} & \textbf{MR2} & \textbf{MP} \\
 & \textbf{(Sin Desfrag.)} & \textbf{(Periódico)} & \textbf{(Umbral)} & \textbf{(Doble Umbral)} \\
\hline
\textbf{Demandas totales} & 99,590 & 100,184 & 100,066 & 100,023 \\
\textbf{Bloqueos (BL)} & 1,693 & 1,561 & \textbf{1,397} & 1,473 \\
\textbf{Prob. bloqueo} & 1.700\% & 1.558\% & \textbf{1.397\%} & 1.473\% \\
\textbf{Desfragmentaciones} & 0 & 19 & 15 & 16 \\
\textbf{Desfrag. preventivas} & - & 19 (100\%) & 8 (53.3\%) & 9 (56.3\%) \\
\textbf{Desfrag. reactivas} & - & - & 7 (46.7\%) & 7 (43.8\%) \\
\hline
\end{tabular}
\end{table}
...
En este escenario de carga media, la línea base SD muestra degradación significativa con 1.700\% de bloqueos, superando en más de un 20\% al mejor método con desfragmentación. El método propuesto (MP) demuestra su capacidad adaptativa alternando entre intervenciones preventivas (56.3\%) y reactivas (43.8\%). El modelo de predicción identificó correctamente:
...
\textbf{Métrica} & \textbf{SD} & \textbf{MR1} & \textbf{MR2} & \textbf{MP} \\
 & \textbf{(Sin Desfrag.)} & \textbf{(Periódico)} & \textbf{(Umbral)} & \textbf{(Doble Umbral)} \\
\hline
\textbf{Demandas totales} & 99,752 & 99,896 & 100,066 & 100,174 \\
\textbf{Bloqueos (BL)} & 3,576 & 3,262 & \textbf{2,873} & 2,986 \\
\textbf{Prob. bloqueo} & 3.585\% & 3.265\% & \textbf{2.871\%} & 2.981\% \\
\textbf{Desfragmentaciones} & 0 & 19 & 18 & 18 \\
\textbf{Desfrag. preventivas} & - & 19 (100\%) & 7 (38.9\%) & 7 (38.9\%) \\
...
\begin{itemize}
    ...
    \item \textbf{Mejora sobre línea base}: MP reduce bloqueos en 16.8\% respecto a SD, demostrando el valor agregado de la desfragmentación adaptativa
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Mejora sustancial sobre línea base}: MP reduce bloqueos entre 13.4\% y 19.8\% respecto a la operación sin desfragmentación, demostrando el valor crítico de la gestión activa de fragmentación
    ...
    \item \textbf{Reducción de bloqueos}: En escenario de alta carga, MP logra 8.7\% menos bloqueos que MR1 con número similar de desfragmentaciones
